...
const ESCAPE_SYMBOL = '$$'
const shorthands = ['ref', 'computed', 'shallowRef', 'toRef', 'customRef'] //  shorthands and transformCheckRE are tightly related.
const transformCheckRE = /[^\w]\$(?:\$|ref|computed|shallowRef|toRef|customRef)?\s*(\(|\<)/
