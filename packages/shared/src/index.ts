...
export const isFunction = (val: unknown): val is Function => toTypeString(val) === '[object Function]'
export const isString = (val: unknown): val is string => toTypeString(val) === '[object String]'
export const isSymbol = (val: unknown): val is symbol => toTypeString(val) === '[object Symbol]'
