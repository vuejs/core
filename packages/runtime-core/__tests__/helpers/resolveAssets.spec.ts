...
describe('resolveAssets', () => {
  ...
  describe('warning', () => {
    ...
    test('resolve dynamic component', () => {
      ...
      const Root = {
        ...
        setup() {
          return () => {
            ...
            emptyVNode = createVNode(resolveDynamicComponent('')) // <component :is="''"/>
            return h(Child, () => {
      ...
      // #3632 an empty string is falsy too, and should not warn
      expect(emptyVNode!.type).toBe(Comment)
    })
