...
import { getHydrationScenarios } from '../src/bench/targets.mjs'

const reportRunId = process.env.BENCH_REPORT_RUN_ID || createReportRunId()
console.info(
  `Hydration reports will be written as reports/*-report-${reportRunId}.md`,
)

for (const scenario of getHydrationScenarios()) {
